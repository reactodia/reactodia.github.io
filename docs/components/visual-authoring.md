...
[`<VisualAuthoring />`](/docs/api/workspace/functions/VisualAuthoring) component is a [canvas widget](/docs/components/canvas.md#widgets) to provide UI for the [visual graph authoring](/docs/concepts/graph-authoring.md).
