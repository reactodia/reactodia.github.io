...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react/jsx-runtime */ \"./node_modules/react/jsx-runtime.js\");\n/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ \"./node_modules/react/index.js\");\n/* harmony import */ var n3__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! n3 */ \"./node_modules/n3/src/N3Parser.js\");\n/* harmony import */ var _src_workspace__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../src/workspace */ \"./src/workspace.ts\");\n/* harmony import */ var _resources_exampleMetadataApi__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./resources/exampleMetadataApi */ \"./examples/resources/exampleMetadataApi.ts\");\n/* harmony import */ var _resources_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./resources/common */ \"./examples/resources/common.tsx\");\n\n\n\n\n\n\nconst TURTLE_DATA = __webpack_require__(/*! ./resources/orgOntology.ttl */ \"./examples/resources/orgOntology.ttl\");\nconst Layouts = _src_workspace__WEBPACK_IMPORTED_MODULE_2__.defineLayoutWorker(() => new Worker('layout.worker.js'));\nfunction RdfExample() {\n    const { defaultLayout } = _src_workspace__WEBPACK_IMPORTED_MODULE_2__.useWorker(Layouts);\n    const [turtleData, setTurtleData] = react__WEBPACK_IMPORTED_MODULE_1__.useState(TURTLE_DATA);\n    const { onMount } = _src_workspace__WEBPACK_IMPORTED_MODULE_2__.useLoadedWorkspace(async ({ context, signal }) => {\n        const { model } = context;\n        const dataProvider = new _src_workspace__WEBPACK_IMPORTED_MODULE_2__.RdfDataProvider();\n        try {\n            dataProvider.addGraph(new n3__WEBPACK_IMPORTED_MODULE_5__[\"default\"]().parse(turtleData));\n        }\n        catch (err) {\n            throw new Error('Error parsing RDF graph data', { cause: err });\n        }\n        const diagram = (0,_resources_common__WEBPACK_IMPORTED_MODULE_4__.tryLoadLayoutFromLocalStorage)();\n        model.importLayout({\n            diagram,\n            dataProvider,\n            validateLinks: true,\n            signal,\n        });\n    }, [turtleData]);\n    const [metadataApi] = react__WEBPACK_IMPORTED_MODULE_1__.useState(() => new _resources_exampleMetadataApi__WEBPACK_IMPORTED_MODULE_3__.ExampleMetadataApi());\n    const [validationApi] = react__WEBPACK_IMPORTED_MODULE_1__.useState(() => new _resources_exampleMetadataApi__WEBPACK_IMPORTED_MODULE_3__.ExampleValidationApi());\n    const suggestProperties = react__WEBPACK_IMPORTED_MODULE_1__.useCallback(params => {\n        let maxLength = 0;\n        for (const iri of params.properties) {\n            maxLength = Math.max(maxLength, iri.length);\n        }\n        const scores = params.properties.map((p) => ({\n            propertyIri: p,\n            score: 1 - p.length / maxLength,\n        }));\n        return _src_workspace__WEBPACK_IMPORTED_MODULE_2__.delay(300).then(() => scores);\n    }, []);\n    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_src_workspace__WEBPACK_IMPORTED_MODULE_2__.Workspace, { ref: onMount, defaultLayout: defaultLayout, metadataApi: metadataApi, validationApi: validationApi, typeStyleResolver: _src_workspace__WEBPACK_IMPORTED_MODULE_2__.SemanticTypeStyles, groupBy: [\n            { linkType: 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', linkDirection: 'in' },\n        ], onIriClick: ({ iri }) => window.open(iri), children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_src_workspace__WEBPACK_IMPORTED_MODULE_2__.DefaultWorkspace, { canvas: {\n                elementTemplateResolver: types => {\n                    if (types.length === 0) {\n                        // use group template only for classes\n                        return _src_workspace__WEBPACK_IMPORTED_MODULE_2__.GroupTemplate;\n                    }\n                    else if (types.includes('http://www.w3.org/2002/07/owl#DatatypeProperty')) {\n                        return _src_workspace__WEBPACK_IMPORTED_MODULE_2__.ClassicTemplate;\n                    }\n                    return undefined;\n                },\n                linkTemplateResolver: type => {\n                    if (type === 'http://www.w3.org/2000/01/rdf-schema#subClassOf') {\n                        return {\n                            ..._src_workspace__WEBPACK_IMPORTED_MODULE_2__.DefaultLinkTemplate,\n                            editableLabel: EDITABLE_LINK_LABEL,\n                        };\n                    }\n                    return _src_workspace__WEBPACK_IMPORTED_MODULE_2__.OntologyLinkTemplates(type);\n                },\n            }, connectionsMenu: { suggestProperties }, toolbar: {\n                menu: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ToolbarActionOpenTurtleGraph, { onOpen: setTurtleData }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_resources_common__WEBPACK_IMPORTED_MODULE_4__.ExampleToolbarMenu, {})] })\n            } }) }));\n}\nconst CUSTOM_LINK_LABEL_IRI = 'urn:example:custom-link-label';\nconst EDITABLE_LINK_LABEL = {\n    getLabel: link => {\n        const { linkState } = link;\n        if (linkState &&\n            Object.prototype.hasOwnProperty.call(linkState, CUSTOM_LINK_LABEL_IRI)) {\n            const customLabel = linkState[CUSTOM_LINK_LABEL_IRI];\n            if (typeof customLabel === 'string') {\n                return customLabel;\n            }\n        }\n        return undefined;\n    },\n    setLabel: (link, label) => {\n        link.setLinkState({\n            ...link.linkState,\n            [CUSTOM_LINK_LABEL_IRI]: label.length === 0 ? undefined : label,\n        });\n    },\n};\nfunction ToolbarActionOpenTurtleGraph(props) {\n    const { onOpen } = props;\n    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_src_workspace__WEBPACK_IMPORTED_MODULE_2__.ToolbarActionOpen, { fileAccept: '.ttl', onSelect: async (file) => {\n            const turtleText = await file.text();\n            onOpen(turtleText);\n        }, children: \"Load RDF (Turtle) data\" }));\n}\n(0,_resources_common__WEBPACK_IMPORTED_MODULE_4__.mountOnLoad)((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(RdfExample, {}));\n\n\n//# sourceURL=webpack://@reactodia/workspace/./examples/rdf.tsx?");
